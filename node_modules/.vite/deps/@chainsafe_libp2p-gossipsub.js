import "./chunk-B3RTTHNE.js";
import {
  pipe
} from "./chunk-PYFHFCBD.js";
import {
  decode,
  encode
} from "./chunk-5GD2B5DG.js";
import {
  pushable
...
import {
  ...
  unmarshalPrivateKey,
  unmarshalPublicKey
} from "./chunk-YEZ7DRHO.js";
import {
  CodeError as CodeError2,
  decodeMessage,
  encodeMessage,
  message
} from "./chunk-NM6EMWD5.js";
import "./chunk-2F2YOVI2.js";
import {
  convertToString
} from "./chunk-AJ3AZTUM.js";
import "./chunk-62PHBWD2.js";
import {
  fromString,
  sha256,
  toString
} from "./chunk-E7PLO4OI.js";
...
var GossipSub = class extends TypedEventEmitter {
  ...
  async handleReceivedRpc(from, rpc) {
    ...
    for (const message2 of rpc.messages) {
      ...
      const handleReceivedMessagePromise = this.handleReceivedMessage(from, message2).catch((err) => {
