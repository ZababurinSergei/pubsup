  ...
  "node_modules/hashlru/index.js"(exports, module) {
    module.exports = function(max) {
      ...
      return {
        ...
        set: /* @__PURE__ */ __name(function(key, value2) {
...
var StreamMessageEvent = class extends Event {
  static {
    __name(this, "StreamMessageEvent");
  }
  data;
...
function decode4(multihash) {
  ...
  const [code4, sizeOffset] = decode3(bytes);
...
function from2({ name: name3, code: code4, encode: encode8, minDigestLength, maxDigestLength }) {
  return new Hasher(name3, code4, encode8, minDigestLength, maxDigestLength);
}
__name(from2, "from");
var Hasher = class {
  static {
  ...
  minDigestLength;
  maxDigestLength;
  constructor(name3, code4, encode8, minDigestLength, maxDigestLength) {
    this.name = name3;
    this.code = code4;
    this.encode = encode8;
...
__name(encodeOctetString, "encodeOctetString");
...
__name(generateECDSAKey, "generateECDSAKey");
...
__name(split, "split");
var shrSH = /* @__PURE__ */ __name((h, _l, s2) => h >>> s2, "shrSH");
var shrSL = /* @__PURE__ */ __name((h, l2, s2) => h << 32 - s2 | l2 >>> s2, "shrSL");
var rotrSH = /* @__PURE__ */ __name((h, l2, s2) => h >>> s2 | l2 << 32 - s2, "rotrSH");
var rotrSL = /* @__PURE__ */ __name((h, l2, s2) => h << 32 - s2 | l2 >>> s2, "rotrSL");
var rotrBH = /* @__PURE__ */ __name((h, l2, s2) => h << 64 - s2 | l2 >>> s2 - 32, "rotrBH");
var rotrBL = /* @__PURE__ */ __name((h, l2, s2) => h >>> s2 - 32 | l2 << 64 - s2, "rotrBL");
...
var isPosBig = /* @__PURE__ */ __name((n2) => typeof n2 === "bigint" && _0n <= n2, "isPosBig");
...
var bitMask = /* @__PURE__ */ __name((n2) => (_1n << BigInt(n2)) - _1n, "bitMask");
...
function validateObject(object, fields = {}, optFields = {}) {
  ...
  const iter = /* @__PURE__ */ __name((f2, isOpt) => Object.entries(f2).forEach(([k, v]) => checkField(k, v, isOpt)), "iter");
  iter(fields, false);
  iter(optFields, true);
}
...
function tonelliShanks(P) {
  ...
  return /* @__PURE__ */ __name(function tonelliSlow(Fp, n2) {
    if (Fp.is0(n2))
      return n2;
...
function edwards(params, extraOpts = {}) {
  ...
  const modP = /* @__PURE__ */ __name((n2) => Fp.create(n2), "modP");
...
__name(hashAndSignWebCrypto, "hashAndSignWebCrypto");
...
__name(hashAndSignNoble, "hashAndSignNoble");
...
function _splitEndoScalar(k, basis, n2) {
  ...
  if (k2neg)
    k2 = -k2;
  const MAX_NUM = bitMask(Math.ceil(bitLen(n2) / 2)) + _1n6;
...
function weierstrass(params, extraOpts = {}) {
  ...
  class Point {
    ...
    multiply(scalar) {
      ...
      let point, fake;
      const mul = /* @__PURE__ */ __name((n2) => wnaf.cached(this, n2, (p2) => normalizeZ(Point, p2)), "mul");
      if (endo2) {
...
function ecdsa(Point, hash, ecdsaOpts = {}) {
  ...
  function prepSig(message2, secretKey, opts) {
    ...
    function k2sig(kBytes) {
      ...
      if (s2 === _0n5)
        return;
      let recovery = (q.x === r2 ? 0 : 2) | Number(q.y & _1n6);
      let normS = s2;
...
function _pushable(getNext, options) {
  ...
  const push = /* @__PURE__ */ __name((value2) => {
    if (ended) {
      return pushable2;
    }
...
__name(isLinkLocal, "isLinkLocal");
...
__name(isLoopbackAddr, "isLoopbackAddr");
...
__name(isNetworkAddress, "isNetworkAddress");
...
var Queue = class extends TypedEventEmitter {
  ...
  async *toGenerator(options) {
    ...
    const onQueueFailure = /* @__PURE__ */ __name((evt) => {
...
var AbstractMessageStream = class extends TypedEventEmitter {
  static {
    __name(this, "AbstractMessageStream");
  }
  status;
  timeline;
  inactivityTimeout;
  ...
  constructor(init) {
    ...
    const continueSendingOnDrain = /* @__PURE__ */ __name(() => {
  ...
  async onDrain(options) {
    ...
    return raceSignal2(this.onDrainPromise.promise, options?.signal);
  }
  async *[Symbol.asyncIterator]() {
    ...
    const streamAsyncIterableOnMessageListener = /* @__PURE__ */ __name((evt) => {
      output.push(evt.data);
    }, "streamAsyncIterableOnMessageListener");
    this.addEventListener("message", streamAsyncIterableOnMessageListener);
    const streamAsyncIterableOnCloseListener = /* @__PURE__ */ __name((evt) => {
      output.end(evt.error);
    }, "streamAsyncIterableOnCloseListener");
    this.addEventListener("close", streamAsyncIterableOnCloseListener);
    const streamAsyncIterableOnRemoteCloseWriteListener = /* @__PURE__ */ __name(() => {
      output.end();
...
var AbstractMultiaddrConnection = class extends AbstractMessageStream {
  static {
    __name(this, "AbstractMultiaddrConnection");
  }
  remoteAddr;
  metricPrefix;
  metrics;
...
var AbstractStreamMuxer = class extends TypedEventEmitter {
  static {
    __name(this, "AbstractStreamMuxer");
  }
  streams;
  protocol;
  status;
  ...
  constructor(maConn, init) {
    ...
    this.metrics = init.metrics;
    const muxerMaConnOnMessage = /* @__PURE__ */ __name((evt) => {
      try {
    ...
    }, "muxerMaConnOnMessage");
    this.maConn.addEventListener("message", muxerMaConnOnMessage);
    const muxerMaConnOnDrain = /* @__PURE__ */ __name(() => {
    ...
    const muxerOnMaConnClose = /* @__PURE__ */ __name(() => {
  ...
  async close(options) {
    ...
    this.status = "closing";
    await raceSignal2(Promise.all([...this.streams].map(async (s2) => {
  ...
  cleanUpStream(stream) {
    const muxerOnStreamEnd = /* @__PURE__ */ __name((evt) => {
  ...
  const byteStream2 = {
    ...
    async read(options) {
      ...
      while (true) {
        ...
        await raceSignal2(hasBytes.promise, options?.signal);
        if (isEOF(stream)) {
  ...
  const pbStream2 = {
    ...
    pb: /* @__PURE__ */ __name((proto) => {
      return {
        ...
        write: /* @__PURE__ */ __name(async (d2, options) => pbStream2.write(d2, proto, options), "write"),
        writeV: /* @__PURE__ */ __name(async (d2, options) => pbStream2.writeV(d2, proto, options), "writeV"),
...
var LengthPrefixedDecoder = class {
  static {
    __name(this, "LengthPrefixedDecoder");
  }
  buffer;
  maxBufferSize;
  lengthDecoder;
...
function repeatingTask(fn, interval, options) {
  ...
  let started = false;
  return {
    setInterval: /* @__PURE__ */ __name((ms) => {
      if (interval === ms) {
        return;
      }
      interval = ms;
...
__name(repeatingTask, "repeatingTask");
...
var encodeStr = /* @__PURE__ */ __name((str) => Uint8Array.from(str.split(""), (c2) => c2.charCodeAt(0)), "encodeStr");
...
// node_modules/@chainsafe/libp2p-noise/node_modules/@noble/hashes/utils.js
...
function abytes3(value2, length3, title = "") {
...
// node_modules/@chainsafe/libp2p-noise/node_modules/@noble/hashes/_md.js
...
// node_modules/@chainsafe/libp2p-noise/node_modules/@noble/hashes/sha2.js
...
// node_modules/@chainsafe/libp2p-noise/node_modules/@noble/curves/utils.js
var _0n6 = /* @__PURE__ */ BigInt(0);
function abignumber2(n2) {
  if (typeof n2 === "bigint") {
    if (!isPosBig2(n2))
      throw new Error("positive bigint expected, got " + n2);
  } else
...
__name(numberToBytesBE3, "numberToBytesBE");
...
__name(copyBytes3, "copyBytes");
var isPosBig2 = /* @__PURE__ */ __name((n2) => typeof n2 === "bigint" && _0n6 <= n2, "isPosBig");
...
// node_modules/@chainsafe/libp2p-noise/node_modules/@noble/curves/abstract/modular.js
...
// node_modules/@chainsafe/libp2p-noise/node_modules/@noble/curves/abstract/curve.js
...
__name(createKeygen2, "createKeygen");

// node_modules/@chainsafe/libp2p-noise/node_modules/@noble/curves/abstract/montgomery.js
var _0n8 = BigInt(0);
var _1n7 = BigInt(1);
var _2n6 = BigInt(2);
...
function montgomery(curveDef) {
  ...
  const modP = /* @__PURE__ */ __name((n2) => mod2(n2, P), "modP");
  const GuBytes = encodeU(Gu);
  function encodeU(u) {
    return numberToBytesLE2(modP(u), fieldLen);
  }
  __name(encodeU, "encodeU");
  function decodeU(u) {
  ...
  function montgomeryLadder(u, scalar) {
    ...
    let z_3 = _1n7;
    let swap = _0n8;
    for (let t2 = BigInt(montgomeryBits - 1); t2 >= _0n8; t2--) {
      const k_t = k >> t2 & _1n7;
      swap ^= k_t;
  ...
  const randomSecretKey = /* @__PURE__ */ __name((seed = randomBytes_(fieldLen)) => {
...
// node_modules/@chainsafe/libp2p-noise/node_modules/@noble/curves/ed25519.js
var _1n8 = BigInt(1);
var _2n7 = BigInt(2);
...
// node_modules/@chainsafe/libp2p-noise/node_modules/@noble/hashes/hmac.js
var _HMAC2 = class {
  static {
    __name(this, "_HMAC");
  }
...
var hmac2 = /* @__PURE__ */ __name((hash, key, message2) => new _HMAC2(hash, key).update(message2).digest(), "hmac");
hmac2.create = (hash, key) => new _HMAC2(hash, key);

// node_modules/@chainsafe/libp2p-noise/node_modules/@noble/hashes/hkdf.js
...
var uint16BEEncode = /* @__PURE__ */ __name((value2) => {
...
var EncryptedMessageStream = class extends AbstractMessageStream {
  static {
    __name(this, "EncryptedMessageStream");
  }
  stream;
  handshake;
  metrics;
  ...
  constructor(stream, handshake, metrics) {
    ...
    this.decoder = new LengthPrefixedDecoder({
      ...
      encodingLength: /* @__PURE__ */ __name(() => 2, "encodingLength")
    });
    const noiseOnMessageDecrypt = /* @__PURE__ */ __name((evt) => {
      try {
    ...
    }, "noiseOnMessageDecrypt");
    this.stream.addEventListener("message", noiseOnMessageDecrypt);
    const noiseOnClose = /* @__PURE__ */ __name((evt) => {
      if (evt.error != null) {
        if (evt.local === true) {
    ...
    const noiseOnDrain = /* @__PURE__ */ __name(() => {
      this.safeDispatchEvent("drain");
    }, "noiseOnDrain");
    this.stream.addEventListener("drain", noiseOnDrain);
    const noiseOnRemoteCloseWrite = /* @__PURE__ */ __name(() => {
      this.onRemoteCloseWrite();
    }, "noiseOnRemoteCloseWrite");
...
__name(toMessageStream, "toMessageStream");
...
// node_modules/@chainsafe/libp2p-yamux/node_modules/race-signal/dist/src/index.js
function defaultTranslate2(signal) {
  return signal.reason;
}
__name(defaultTranslate2, "defaultTranslate");
...
__name(isDataFrame, "isDataFrame");
var twoPow24 = 2 ** 24;
...
var YamuxStream = class extends AbstractStream {
  ...
  constructor(init) {
    ...
    const setStateToFinishedOnCloseListener = /* @__PURE__ */ __name(() => {
      this.state = StreamState.Finished;
    }, "setStateToFinishedOnCloseListener");
...
var YamuxMuxer = class extends AbstractStreamMuxer {
  ...
  async ping(options) {
    ...
    if (this.activePing != null) {
      return raceSignal3(this.activePing.promise, options?.signal);
    }
    ...
    try {
      this.rtt = await raceSignal3(this.activePing.promise, options?.signal);
    } finally {
...
function arrayEquals(a2, b) {
  const sort2 = /* @__PURE__ */ __name((a3, b2) => a3.toString().localeCompare(b2.toString()), "sort");
  if (a2.length !== b.length) {
    return false;
  }
  b.sort(sort2);
...
var code2 = /* @__PURE__ */ __name((code4) => {
  return {
...
__name(getLastDial, "getLastDial");
...
var CircuitRelayTransportListener = class extends TypedEventEmitter {
  ...
  _onAddRelayPeer = /* @__PURE__ */ __name((evt) => {
...
var StreamMultiaddrConnection = class extends AbstractMultiaddrConnection {
  static {
    __name(this, "StreamMultiaddrConnection");
  }
  stream;
  init;
  constructor(init) {
...
async function consumeIdentifyMessage(peerStore, events, log3, connection, message2) {
  ...
  if (message2.signedPeerRecord != null) {
    log3.trace("received signedPeerRecord from %p", connection.remotePeer);
  ...
  log3.trace("patching %p with", connection.remotePeer, peer);
  ...
  if (message2.agentVersion != null || message2.protocolVersion != null) {
    ...
    log3.trace("merging %p metadata", connection.remotePeer, metadata);
...
var Identify2 = class extends AbstractIdentify {
  ...
  async _identify(connection, options = {}) {
    ...
    try {
      ...
      log3 = stream.log.newScope("identify");
      ...
      log3?.error("identify failed - %e", err);
      stream?.abort(err);
      throw err;
    }
  }
  ...
  async handleProtocol(stream, connection) {
    const log3 = stream.log.newScope("identify");
    log3("responding to identify");
    const signal = AbortSignal.timeout(this.timeout);
    setMaxListeners(Infinity, signal);
...
__name(defaultTranslate3, "defaultTranslate");
...
var WebRTCStream = class extends AbstractStream {
  ...
  constructor(init) {
    ...
    const cleanUpDatachannelOnClose = /* @__PURE__ */ __name(() => {
      if (this.channel.readyState === "open") {
        this.log.trace("stream closed, closing underlying datachannel");
        this.channel.close();
      }
    }, "cleanUpDatachannelOnClose");
  ...
  async sendCloseWrite(options) {
    ...
    await Promise.any([
      raceSignal4(this.receivedFinAck.promise, signal),
      ...eventPromises
    ]).finally(() => {
...
var RTCPeerConnectionMultiaddrConnection = class extends AbstractMultiaddrConnection {
  static {
    __name(this, "RTCPeerConnectionMultiaddrConnection");
  }
  peerConnection;
  constructor(init) {
    super(init);
...
var toMultiaddrConnection = /* @__PURE__ */ __name((init) => {
...
async function initiateConnection({ rtcConfiguration, dataChannel, signal, metrics, multiaddr: ma, connectionManager, transportManager, log: log3, logger: logger3, onProgress }) {
  const { circuitAddress, targetPeer } = splitAddr(ma);
  metrics?.dialerEvents.increment({ open: true });
  log3.trace("dialing circuit address: %a", circuitAddress);
  ...
  try {
    ...
    peerConnection.onicecandidate = ({ candidate }) => {
      if (peerConnection.connectionState === "connected") {
        log3.trace("ignore new ice candidate as peer connection is already connected");
        return;
      }
      if (candidate == null || candidate?.candidate === "") {
        log3.trace("initiator detected end of ICE candidates");
        return;
      }
      ...
      void messageStream.write({
        ...
        log3.error("error sending ICE candidate - %e", err);
      });
    };
    ...
    const offerSdp = await peerConnection.createOffer().catch((err) => {
      log3.error("could not execute createOffer - %e", err);
    ...
    await peerConnection.setLocalDescription(offerSdp).catch((err) => {
      log3.error("could not execute setLocalDescription - %e", err);
    ...
    log3.trace("initiator read SDP answer");
    ...
    log3.trace("initiator received SDP answer %s", answerMessage.data);
    const answerSdp = new RTCSessionDescription({ type: "answer", sdp: answerMessage.data });
    await peerConnection.setRemoteDescription(answerSdp).catch((err) => {
      log3.error("could not execute setRemoteDescription - %e", err);
    ...
    log3.trace("initiator connected");
    if (channel.readyState !== "open") {
      log3.trace("wait for init channel to open");
      await pEvent(channel, "open", {
        signal
      });
    }
    log3.trace("closing init channel");
    channel.close();
    log3.trace("waiting for init channel to close");
    ...
    log3.error("outgoing signaling error - %e", err);
    peerConnection.close();
    stream.abort(err);
    throw err;
  } finally {
...
async function handleIncomingStream(stream, connection, { peerConnection, signal, log: log3 }) {
  ...
  try {
    peerConnection.onicecandidate = ({ candidate }) => {
      ...
      if (candidate == null || candidate?.candidate === "") {
        log3.trace("recipient detected end of ICE candidates");
        return;
      }
      const data = JSON.stringify(candidate?.toJSON() ?? null);
    ...
    log3.trace("recipient read SDP offer");
    ...
    log3.trace("recipient received SDP offer %s", pbOffer.data);
    ...
    const answer = await peerConnection.createAnswer().catch((err) => {
      log3.error("could not execute createAnswer - %e", err);
    ...
    if (peerConnection.connectionState !== "connected") {
      log3.error("error while handling signaling stream from peer %a - %e", connection.remoteAddr, err);
      peerConnection.close();
      throw err;
    } else {
...
var interpreters = {
  ip4: /* @__PURE__ */ __name((head, rest) => head.value, "ip4"),
  ip6: /* @__PURE__ */ __name((head, rest) => {
    if (rest.length === 0) {
      return head.value;
    }
    return `[${head.value}]`;
  }, "ip6"),
  tcp: /* @__PURE__ */ __name((head, rest) => {
    const tail = rest.pop();
    if (tail == null) {
  ...
  dnsaddr: /* @__PURE__ */ __name((head, rest) => head.value, "dnsaddr"),
  dns4: /* @__PURE__ */ __name((head, rest) => head.value, "dns4"),
  dns6: /* @__PURE__ */ __name((head, rest) => head.value, "dns6"),
  dns: /* @__PURE__ */ __name((head, rest) => head.value, "dns"),
  ipfs: /* @__PURE__ */ __name((head, rest) => {
    const tail = rest.pop();
    if (tail == null) {
      throw new Error("Unexpected end of multiaddr");
    }
  ...
  https: /* @__PURE__ */ __name((head, rest) => {
    const tail = rest.pop();
    if (tail == null) {
      throw new Error("Unexpected end of multiaddr");
    }
...
var WebSocketMultiaddrConnection = class extends AbstractMultiaddrConnection {
  static {
    __name(this, "WebSocketMultiaddrConnection");
  }
  websocket;
  maxBufferedAmount;
...
__name(webSocketToMaConn, "webSocketToMaConn");
...
var handleChannelWorkerLockRequest = /* @__PURE__ */ __name((emitter, channel, masterEvent, abortMasterEvent, requestType, abortType, errorType, releaseType, grantType) => {
  return (event) => {
    if (event.data == null) {
      return;
    }
...
var nanoid2 = /* @__PURE__ */ __name((size = 10) => {
...
var MorticeChannelWorker = class {
  static {
    __name(this, "MorticeChannelWorker");
  }
  name;
  channel;
  constructor(name3) {
  ...
  if (implementation == null) {
    ...
    if (!isMortice(implementation)) {
      ...
      emitter.addEventListener("requestReadLock", (event) => {
        ...
        const abortListener = /* @__PURE__ */ __name((event2) => {
...
__name(createReleasable, "createReleasable");
...
__name(compareOptionalUint8Arrays, "compareOptionalUint8Arrays");
...
var PersistentPeerStore = class {
  ...
  async all(query) {
    return src_default4(this.store.all(query));
  }
  async delete(peerId, options) {
...
var Key2 = class _Key {
  ...
  constructor(s2, clean5) {
    ...
    if (this._buf.byteLength === 0 || this._buf[0] !== pathSep2) {
      throw new Error("Invalid key");
    }
  }
  /**
   ...
   */
  static withNamespaces(list) {
    return new _Key(list.join(pathSepS2));
  }
  /**
   * Returns a randomly (uuid) generated key.
   *
  ...
  clean() {
    ...
    if (this._buf[0] !== pathSep2) {
      const bytes = new Uint8Array(this._buf.byteLength + 1);
      bytes.fill(pathSep2, 0, 1);
      bytes.set(this._buf, 1);
      this._buf = bytes;
    }
    while (this._buf.byteLength > 1 && this._buf[this._buf.byteLength - 1] === pathSep2) {
      this._buf = this._buf.subarray(0, -1);
    }
  }
  /**
   ...
   */
  list() {
    return this.toString().split(pathSepS2).slice(1);
  }
  /**
   * Returns the "type" of this key (value of last namespace).
   *
  ...
  parent() {
    const list = this.list();
    if (list.length === 1) {
      return new _Key(pathSepS2);
    }
    return new _Key(list.slice(0, -1).join(pathSepS2));
  }
  /**
   * Returns the `child` Key of this Key.
   *
   ...
   */
  child(key) {
    if (this.toString() === pathSepS2) {
      return key;
    } else if (key.toString() === pathSepS2) {
      return this;
    }
    return new _Key(this.toString() + key.toString(), false);
  }
...
__name(namespaceType2, "namespaceType");
function namespaceValue2(ns) {
  const parts = ns.split(":");
  return parts[parts.length - 1];
}
__name(namespaceValue2, "namespaceValue");
...
var MemoryDatastore = class extends BaseDatastore {
  ...
  *_all(q, options) {
    ...
    for (const [key, value2] of this.data.entries()) {
      yield { key: new Key2(key), value: value2 };
      options?.signal?.throwIfAborted();
    }
  }
  *_allKeys(q, options) {
...
var TransportAddresses = class {
  static {
    __name(this, "TransportAddresses");
  }
  log;
  addresses;
  maxObservedAddresses;
...
var UnsupportedListenAddressError = class extends Error {
  static {
    __name(this, "UnsupportedListenAddressError");
  }
...
var UnsupportedListenAddressesError = class extends Error {
  static {
    __name(this, "UnsupportedListenAddressesError");
  }
...
__name(multiaddrToIpNet, "multiaddrToIpNet");
function isDirect(ma) {
  return !Circuit.exactMatch(ma);
}
__name(isDirect, "isDirect");
...
__name(findExistingConnection, "findExistingConnection");
...
__name(loopbackAddressLast, "loopbackAddressLast");
...
__name(resolveMultiaddr, "resolveMultiaddr");
...
var isError = /* @__PURE__ */ __name((value2) => objectToString.call(value2) === "[object Error]", "isError");
...
__name(hasKeepAliveTag, "hasKeepAliveTag");
...
var CompoundContentRouting = class {
  ...
  constructor(components, init) {
    ...
    this.findProviders = components.metrics?.traceFunction("libp2p.contentRouting.findProviders", this.findProviders.bind(this), {
      optionsIndex: 1,
      getAttributesFromArgs: /* @__PURE__ */ __name(([cid], attrs) => {
        return {
          ...attrs,
          cid: cid.toString()
        };
      }, "getAttributesFromArgs"),
      getAttributesFromYieldedValue: /* @__PURE__ */ __name((value2, attrs) => {
        return {
          ...attrs,
    ...
    this.put = components.metrics?.traceFunction("libp2p.contentRouting.put", this.put.bind(this), {
      optionsIndex: 2,
      getAttributesFromArgs: /* @__PURE__ */ __name(([key]) => {
        return {
...
var DefaultPeerRouting = class {
  ...
  constructor(components, init = {}) {
    ...
    this.findPeer = components.metrics?.traceFunction("libp2p.peerRouting.findPeer", this.findPeer.bind(this), {
      optionsIndex: 1,
      getAttributesFromArgs: /* @__PURE__ */ __name(([peer], attrs) => {
        return {
          ...attrs,
          peer: peer.toString()
        };
    ...
    this.getClosestPeers = components.metrics?.traceFunction("libp2p.peerRouting.getClosestPeers", this.getClosestPeers.bind(this), {
      optionsIndex: 1,
      getAttributesFromArgs: /* @__PURE__ */ __name(([key], attrs) => {
        return {
          ...attrs,
          key: toString2(key, "base36")
        };
...
// node_modules/libp2p/node_modules/race-signal/dist/src/index.js
function defaultTranslate4(signal) {
  return signal.reason;
}
__name(defaultTranslate4, "defaultTranslate");
async function raceSignal5(promise, signal, opts) {
  if (signal == null) {
    return promise;
  }
  const translateError = opts?.translateError ?? defaultTranslate4;
  if (signal.aborted) {
    promise.catch(() => {
    });
    return Promise.reject(translateError(signal));
        ...
        try {
          ...
          for await (const peer of this.peerRouting.getClosestPeers(data, { signal })) {
            ...
            if (this.walkers === 1 && this.needNext != null) {
              ...
              await raceSignal5(this.needNext.promise, signal);
            }
            s2 = Date.now();
          }
...
async function select(stream, protocols, options = {}) {
  ...
  const log3 = stream.log.newScope("mss:select");
  ...
  for (let i2 = 0; i2 < protocols.length; i2++) {
    ...
    let response;
    if (i2 === 0) {
      log3.trace('write ["%s", "%s"]', PROTOCOL_ID, protocol);
      const p1 = fromString2(`${PROTOCOL_ID}
`);
      const p2 = fromString2(`${protocol}
`);
      await lp.writeV([p1, p2], options);
      log3.trace("reading multistream-select header");
      response = await readString(lp, options);
      log3.trace('read "%s"', response);
      if (response !== PROTOCOL_ID) {
        log3.error("did not read multistream-select header from response");
        break;
      }
    } else {
      log3.trace('write "%s"', protocol);
      await lp.write(fromString2(`${protocol}
`), options);
    }
    log3.trace("reading protocol response");
    response = await readString(lp, options);
    log3.trace('read "%s"', response);
    if (response === protocol) {
      log3.trace('selected "%s" after negotiation', response);
      lp.unwrap();
      return protocol;
    }
  }
...
async function handle(stream, protocols, options = {}) {
  protocols = Array.isArray(protocols) ? protocols : [protocols];
  const log3 = stream.log.newScope("mss:handle");
  const lp = lpStream(stream, {
    ...options,
    maxDataLength: MAX_PROTOCOL_LENGTH,
    maxLengthLength: 2
  ...
  while (true) {
    log3.trace("reading incoming string");
    const protocol = await readString(lp, options);
    log3.trace('read "%s"', protocol);
    if (protocol === PROTOCOL_ID) {
      log3.trace('respond with "%s" for "%s"', PROTOCOL_ID, protocol);
      await lp.write(fromString2(`${PROTOCOL_ID}
`), options);
      log3.trace('responded with "%s" for "%s"', PROTOCOL_ID, protocol);
      continue;
    }
    if (protocols.includes(protocol)) {
      log3.trace('respond with "%s" for "%s"', protocol, protocol);
      await lp.write(fromString2(`${protocol}
`), options);
      log3.trace('responded with "%s" for "%s"', protocol, protocol);
      lp.unwrap();
      return protocol;
    }
    if (protocol === "ls") {
...
`))), fromString2("\n"));
      log3.trace('respond with "%s" for %s', protocols, protocol);
      await lp.write(protos, options);
      log3.trace('responded with "%s" for %s', protocols, protocol);
      continue;
    }
    log3.trace('respond with "na" for "%s"', protocol);
    await lp.write(fromString2("na\n"), options);
    log3('responded with "na" for "%s"', protocol);
  }
}
...
var Upgrader = class {
  ...
  async upgradeInbound(maConn, opts) {
    ...
    try {
      ...
      await raceSignal5(this.shouldBlockConnection("denyInboundConnection", maConn), signal);
  ...
  async upgradeOutbound(maConn, opts) {
    try {
      ...
      if (idStr != null) {
        ...
        await raceSignal5(this.shouldBlockConnection("denyOutboundConnection", remotePeerId, maConn), opts.signal);
      }
...
__name(isEncryptionSkipped, "isEncryptionSkipped");
...
var shardKey = new Key2(SHARDING_FN);
...
src_default2.formatters.e = (v) => {
  ...
  const message2 = notEmpty2(v.message);
  const stack = notEmpty2(v.stack);
  if (message2 != null && stack != null) {
    if (stack.includes(message2)) {
      return stack;
    }
...
__name(notEmpty2, "notEmpty");

// node_modules/datastore-core/dist/src/tiered.js
var log2 = logger2("datastore:core:tiered");
...
// node_modules/datastore-idb/node_modules/interface-datastore/dist/src/key.js
var pathSepS4 = "/";
...
__name(namespaceType3, "namespaceType");
function namespaceValue3(ns) {
  const parts = ns.split(":");
  return parts[parts.length - 1];
}
__name(namespaceValue3, "namespaceValue");
function flatten3(arr) {
  return [].concat(...arr);
}
__name(flatten3, "flatten");

// node_modules/datastore-idb/node_modules/interface-store/dist/src/errors.js
var OpenFailedError2 = class _OpenFailedError extends Error {
...
var PutFailedError2 = class _PutFailedError extends Error {
...
var DeleteFailedError2 = class _DeleteFailedError extends Error {
...
// node_modules/datastore-idb/node_modules/race-signal/dist/src/index.js
function defaultTranslate5(signal) {
  return signal.reason;
}
__name(defaultTranslate5, "defaultTranslate");
async function raceSignal6(promise, signal, opts) {
  if (signal == null) {
    return promise;
  }
  const translateError = opts?.translateError ?? defaultTranslate5;
  if (signal.aborted) {
    promise.catch(() => {
    });
    return Promise.reject(translateError(signal));
...
var IDBDatastore = class extends BaseDatastore {
  ...
  async open() {
    try {
      ...
      throw new OpenFailedError2(String(err));
    }
  }
  async close() {
    this.db?.close();
  ...
  async put(key, val, options) {
    ...
    try {
      options?.signal?.throwIfAborted();
      await raceSignal6(this.db.put(this.location, val, key.toString()), options?.signal);
    } catch (err) {
      throw new PutFailedError2(String(err));
    }
    return key;
  }
  async get(key, options) {
    ...
    try {
      options?.signal?.throwIfAborted();
      val = await raceSignal6(this.db.get(this.location, key.toString()), options?.signal);
    } catch (err) {
  ...
  async has(key, options) {
    ...
    try {
      options?.signal?.throwIfAborted();
      const result = await raceSignal6(this.db.getKey(this.location, key.toString()));
  ...
  async delete(key, options) {
    ...
    try {
      options?.signal?.throwIfAborted();
      await raceSignal6(this.db.delete(this.location, key.toString()), options?.signal);
    } catch (err) {
      throw new DeleteFailedError2(String(err));
    }
  }
  batch() {
    const puts = [];
    ...
    return {
      ...
      commit: /* @__PURE__ */ __name(async (options) => {
        ...
        try {
          ...
          options?.signal?.throwIfAborted();
          await raceSignal6(Promise.all(ops.map(async (op) => {
            await op();
          })), options?.signal);
        } catch {
          tx.abort();
  ...
  async *query(q, options) {
    let it = this.#queryIt(q, (key, value2) => {
  ...
  async *#queryIt(q, transform, options) {
    ...
    for (const key of await this.db.getAllKeys(this.location)) {
      ...
      const k = new Key4(key.toString());
      let value2;
      try {
        value2 = await this.get(k, options);
      } catch (err) {
        if (err.name !== "NotFoundError") {
          throw err;
        }
...
// node_modules/@libp2p/ping/node_modules/race-signal/dist/src/index.js
function defaultTranslate6(signal) {
  return signal.reason;
}
__name(defaultTranslate6, "defaultTranslate");
async function raceSignal7(promise, signal, opts) {
  if (signal == null) {
    return promise;
  }
  const translateError = opts?.translateError ?? defaultTranslate6;
  if (signal.aborted) {
    promise.catch(() => {
    });
    return Promise.reject(translateError(signal));
...
var Ping = class {
  ...
  async handlePing(stream, connection) {
    const log3 = stream.log.newScope("ping");
    log3.trace("ping from %p", connection.remotePeer);
    const signal = AbortSignal.timeout(this.timeout);
    setMaxListeners(Infinity, signal);
    signal.addEventListener("abort", () => {
    ...
    for await (const buf of stream) {
      if (stream.status !== "open") {
        log3("stream status changed to %s", stream.status);
        break;
      }
      if (!stream.send(buf)) {
        log3("waiting for stream to drain");
        await pEvent(stream, "drain", {
          rejectionEvents: [
            "close"
          ],
    ...
    log3("ping from %p complete in %dms", connection.remotePeer, Date.now() - start2);
    await stream.close({
      signal
    });
  }
  ...
  async ping(peer, options = {}) {
    ...
    try {
      ...
      stream.send(data);
      await stream.close(options);
      return await raceSignal7(finished.promise, options.signal);
    } catch (err) {
      log3.error("error while pinging %o - %e", peer, err);
      stream?.abort(err);
      throw err;
    } finally {
      stream?.close();
...
// docs/constants.js
var PUBSUB_PEER_DISCOVERY = "discovery";
...
// docs/index.js
var serverPeerId = "12D3KooWARz15HEm1CYbAUFZjXFVNuoCcVCiFCxCVxjYJYF6PAqK";
var port = 4839;
var RENDER_EXTERNAL_HOSTNAME = "relay-tuem.onrender.com";
var store = new IDBDatastore("/fs", {
  prefix: "/universe",
  version: 1
});
await store.open();
...
var isBootstrap = urlParams.has("bootstrap");
var isLanKad = urlParams.has("lanKad");
var isDht = urlParams.has("dht");
var isPubsubPeerDiscovery = urlParams.has("pubsubPeerDiscovery");
var isPeerInfoMapper = urlParams.has("peerInfoMapper");
var publicAddressesMapper = removePublicAddressesMapper;
var DhtProtocol = "/universe/kad/1.0.0";
console.log("isBootstrap", isBootstrap);
console.log("isPubsubPeerDiscovery", isPubsubPeerDiscovery);
var DOM = {
  peerId: /* @__PURE__ */ __name(() => document.getElementById("peer-id"), "peerId"),
  dhtMode: /* @__PURE__ */ __name(() => document.getElementById("dht-mode"), "dhtMode"),
  clearButton: /* @__PURE__ */ __name(() => document.getElementById("clear-button"), "clearButton"),
  dialMultiaddrInput: /* @__PURE__ */ __name(() => document.getElementById("dial-multiaddr-input"), "dialMultiaddrInput"),
  dialMultiaddrButton: /* @__PURE__ */ __name(() => document.getElementById("dial-multiaddr-button"), "dialMultiaddrButton"),
  subscribeTopicInput: /* @__PURE__ */ __name(() => document.getElementById("subscribe-topic-input"), "subscribeTopicInput"),
  subscribeTopicButton: /* @__PURE__ */ __name(() => document.getElementById("subscribe-topic-button"), "subscribeTopicButton"),
  sendTopicMessageInput: /* @__PURE__ */ __name(() => document.getElementById("send-topic-message-input"), "sendTopicMessageInput"),
  sendTopicMessageButton: /* @__PURE__ */ __name(() => document.getElementById("send-topic-message-button"), "sendTopicMessageButton"),
  output: /* @__PURE__ */ __name(() => document.getElementById("output"), "output"),
  listeningAddressesList: /* @__PURE__ */ __name(() => document.getElementById("listening-addresses"), "listeningAddressesList"),
  peerConnectionsList: /* @__PURE__ */ __name(() => document.getElementById("peer-connections"), "peerConnectionsList"),
  topicPeerList: /* @__PURE__ */ __name(() => document.getElementById("topic-peers"), "topicPeerList")
};
var appendOutput = /* @__PURE__ */ __name((line) => {
  DOM.output().innerText += `${line}
`;
}, "appendOutput");
var clean4 = /* @__PURE__ */ __name((line) => line.replaceAll("\n", ""), "clean");
var boot = [];
if (isBootstrap) {
...
var libp2p = await createLibp2p({
  ...
  connectionGater: {
    denyDialMultiaddr: /* @__PURE__ */ __name(() => {
      return false;
    }, "denyDialMultiaddr")
  }
});
...
__name(updatePeerList, "updatePeerList");
...
libp2p.addEventListener("self:peer:update", (event) => {
  ...
  const multiaddrs = libp2p.getMultiaddrs().map((ma) => {
    ...
    el.onclick = (event2) => {
      navigator.clipboard.writeText(event2.currentTarget.textContent).then(() => {
...
DOM.sendTopicMessageButton().onclick = async () => {
  const topic = DOM.subscribeTopicInput().value;
  const message2 = DOM.sendTopicMessageInput().value;
  appendOutput(`Sending message '${clean4(message2)}'`);
  await libp2p.services.pubsub.publish(topic, fromString2(message2));
};
setInterval(() => {
  const topic = DOM.subscribeTopicInput().value;
  const peerList = libp2p.services.pubsub.getSubscribers(topic).map((peerId) => {
    const el = document.createElement("li");
    el.textContent = peerId.toString();
    return el;
  });
